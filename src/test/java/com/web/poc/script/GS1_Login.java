...
public class GS1_Login extends TestEngineWeb {
	...
	public void GS1_Login() throws Throwable {
		try {			   
				...
				{	
					...
					extentLogs.fail("GS1_Login status","Not able to logout from GS1");
					testCaseStatus = false;
				}
			...
			testCaseFailureReason = "Failed to complete GS1_Login";
